...
import { useMarbleControl } from "@/SimulationPlay/MarbleSimulation/Hooks/UseMarbleControl";
// コースタイプのenum定義をインポート
import { CourseType } from "@/SimulationPlay/MarbleSimulation/Types/MarbleConfig";
