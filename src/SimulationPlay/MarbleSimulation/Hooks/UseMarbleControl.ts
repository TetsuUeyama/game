...
// Havok物理エンジン管理クラス
import { PhysicsWorld } from "@/SimulationPlay/MarbleSimulation/Physics/PhysicsWorld";
// ビー玉・地面・壁の生成・管理クラス
import { MarbleBody } from "@/SimulationPlay/MarbleSimulation/Physics/MarbleBody";
// 力の制御クラス（コース別ロジック + ヒューマノイド物理）
import { ForceController } from "@/SimulationPlay/MarbleSimulation/Physics/ForceController";
// 設定型定義とデフォルト値
import { DEFAULT_CONFIG, SimulationConfig, CourseType } from "@/SimulationPlay/MarbleSimulation/Types/MarbleConfig";
