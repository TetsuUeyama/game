...
const OUTFITS: OutfitDef[] = [
  ...
  { key: 'hair1',  label: 'Hair 1',    color: '#a76', isHair: true },
  { key: 'hair2',  label: 'Hair 2',    color: '#a76', isHair: true },
];
...
export default function NyotenguNativePage() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        Voxels @ resolution=250, native Nyotengu proportions (no retargeting).{' '}
        Source: <code>G:/nyotengu/Nyotengu_v1.2.blend</code> · Files under{' '}
