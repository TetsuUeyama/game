...
const BASE = '/api/box5/pharah_native';
...
const OUTFITS: OutfitDef[] = [
  ...
  { key: 'hair_default',     label: 'Hair Default',     color: '#221', isHair: true },
  { key: 'hair_ponytail',    label: 'Hair Ponytail',    color: '#221', isHair: true },
  { key: 'hair_short',       label: 'Hair Short',       color: '#221', isHair: true },
...
export default function PharahNativePage() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        Voxels @ resolution=250, native Pharah proportions (no retargeting).{' '}
        Source: <code>E:/MOdel/.../Pharah v5.1.58.blend</code> · Files under{' '}
