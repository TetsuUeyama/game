...
const BASE = '/api/box5/blackwidow_native';
...
const OUTFITS: OutfitDef[] = [
  ...
  { key: 'hair1',            label: 'Hair 1',           color: '#a55', isHair: true },
  { key: 'hair2',            label: 'Hair 2',           color: '#522', isHair: true },
...
export default function BlackWidowNativePage() {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ color: '#234', fontSize: 13, fontWeight: 'bold' }}>
          BlackWidow Native Voxelization
        </span>
      ...
      <div style={{
        ...
        Voxels @ resolution=250, native BlackWidow proportions (no retargeting).{' '}
        Source: <code>G:/BlackWidow/BlackWidow_v1.2.blend</code> · Files under{' '}
