...
const SHOOT_MIDRANGE_JOINT_ANIMATIONS: Record<string, Record<number, number>> = {
  // 上半身：3PTに近いが少し控えめ
  upperBodyX: {[SHOOT_MID_T0]: 0, [SHOOT_MID_T1]: -12, [SHOOT_MID_T2]: -18, [SHOOT_MID_T3]: 8, [SHOOT_MID_T4]: 0},
  ...
  headX: {[SHOOT_MID_T0]: 0, [SHOOT_MID_T1]: -8, [SHOOT_MID_T2]: -18, [SHOOT_MID_T3]: -8, [SHOOT_MID_T4]: 0},
  ...
  // 右腕（シュートハンド）：3PTと同じ軸規約（Z=上げる、Y=前後）
  rightShoulderX: {[SHOOT_MID_T0]: 30, [SHOOT_MID_T1]: 30, [SHOOT_MID_T2]: 30, [SHOOT_MID_T3]: 30, [SHOOT_MID_T4]: 30},
  rightShoulderY: {[SHOOT_MID_T0]: 30, [SHOOT_MID_T1]: 30, [SHOOT_MID_T2]: 40, [SHOOT_MID_T3]: 30, [SHOOT_MID_T4]: 30},
  rightShoulderZ: {[SHOOT_MID_T0]: 96, [SHOOT_MID_T1]: 96, [SHOOT_MID_T2]: 96, [SHOOT_MID_T3]: 96, [SHOOT_MID_T4]: 96},

  rightElbowX: {[SHOOT_MID_T0]: -30, [SHOOT_MID_T1]: -85, [SHOOT_MID_T2]: -105, [SHOOT_MID_T3]: -18, [SHOOT_MID_T4]: -30},
  ...
  // 左腕（ガイドハンド）
  leftShoulderX: {[SHOOT_MID_T0]: 30, [SHOOT_MID_T1]: 30, [SHOOT_MID_T2]: 35, [SHOOT_MID_T3]: 30, [SHOOT_MID_T4]: 30},
  leftShoulderY: {[SHOOT_MID_T0]: 25, [SHOOT_MID_T1]: 35, [SHOOT_MID_T2]: 32, [SHOOT_MID_T3]: 35, [SHOOT_MID_T4]: 30},
  leftShoulderZ: {[SHOOT_MID_T0]: 90, [SHOOT_MID_T1]: 90, [SHOOT_MID_T2]: 90, [SHOOT_MID_T3]: 90, [SHOOT_MID_T4]: 90},

  leftElbowX: {[SHOOT_MID_T0]: -30, [SHOOT_MID_T1]: -55, [SHOOT_MID_T2]: -75, [SHOOT_MID_T3]: -38, [SHOOT_MID_T4]: -30},
  ...
  // 脚：3PTと同じ規約
  leftHipX: {[SHOOT_MID_T0]: 18, [SHOOT_MID_T1]: 3, [SHOOT_MID_T2]: 0, [SHOOT_MID_T3]: 8, [SHOOT_MID_T4]: 18},
  ...
  rightHipX: {[SHOOT_MID_T0]: 25, [SHOOT_MID_T1]: 15, [SHOOT_MID_T2]: 0, [SHOOT_MID_T3]: 8, [SHOOT_MID_T4]: 25},
  ...
  leftKneeX: {[SHOOT_MID_T0]: -20, [SHOOT_MID_T1]: -25, [SHOOT_MID_T2]: 0, [SHOOT_MID_T3]: 0, [SHOOT_MID_T4]: -20},
  ...
  rightKneeX: {[SHOOT_MID_T0]: -25, [SHOOT_MID_T1]: -25, [SHOOT_MID_T2]: -5, [SHOOT_MID_T3]: -25, [SHOOT_MID_T4]: -25},
...
const SHOOT_LAYUP_JOINT_ANIMATIONS: Record<string, Record<number, number>> = {
  // 上半身：やや前傾してリムに向かう
  upperBodyX: {[SHOOT_LAYUP_T0]: 5, [SHOOT_LAYUP_T1]: 0, [SHOOT_LAYUP_T2]: -8, [SHOOT_LAYUP_T3]: 3, [SHOOT_LAYUP_T4]: 5},
  ...
  headX: {[SHOOT_LAYUP_T0]: 0, [SHOOT_LAYUP_T1]: -8, [SHOOT_LAYUP_T2]: -18, [SHOOT_LAYUP_T3]: -5, [SHOOT_LAYUP_T4]: 0},
  ...
  // 右腕：高く伸ばしてリリース（Z=腕上げ、Y=前方伸ばし）
  rightShoulderX: {[SHOOT_LAYUP_T0]: 30, [SHOOT_LAYUP_T1]: 30, [SHOOT_LAYUP_T2]: 30, [SHOOT_LAYUP_T3]: 30, [SHOOT_LAYUP_T4]: 30},
  rightShoulderY: {[SHOOT_LAYUP_T0]: 30, [SHOOT_LAYUP_T1]: 50, [SHOOT_LAYUP_T2]: 70, [SHOOT_LAYUP_T3]: 50, [SHOOT_LAYUP_T4]: 30},
  rightShoulderZ: {[SHOOT_LAYUP_T0]: 96, [SHOOT_LAYUP_T1]: 110, [SHOOT_LAYUP_T2]: 130, [SHOOT_LAYUP_T3]: 110, [SHOOT_LAYUP_T4]: 96},

  rightElbowX: {[SHOOT_LAYUP_T0]: -30, [SHOOT_LAYUP_T1]: -60, [SHOOT_LAYUP_T2]: -20, [SHOOT_LAYUP_T3]: -15, [SHOOT_LAYUP_T4]: -30},
  ...
  // 左腕：ガイドハンド→リリース後は離れる
  leftShoulderX: {[SHOOT_LAYUP_T0]: 30, [SHOOT_LAYUP_T1]: 30, [SHOOT_LAYUP_T2]: 30, [SHOOT_LAYUP_T3]: 30, [SHOOT_LAYUP_T4]: 30},
  leftShoulderY: {[SHOOT_LAYUP_T0]: 25, [SHOOT_LAYUP_T1]: 35, [SHOOT_LAYUP_T2]: 28, [SHOOT_LAYUP_T3]: 25, [SHOOT_LAYUP_T4]: 25},
  leftShoulderZ: {[SHOOT_LAYUP_T0]: 90, [SHOOT_LAYUP_T1]: 90, [SHOOT_LAYUP_T2]: 80, [SHOOT_LAYUP_T3]: 70, [SHOOT_LAYUP_T4]: 90},

  leftElbowX: {[SHOOT_LAYUP_T0]: -30, [SHOOT_LAYUP_T1]: -45, [SHOOT_LAYUP_T2]: -50, [SHOOT_LAYUP_T3]: -35, [SHOOT_LAYUP_T4]: -30},
  ...
  // 脚：左足で踏み切り、右膝を高く上げる
  leftHipX: {[SHOOT_LAYUP_T0]: 15, [SHOOT_LAYUP_T1]: 5, [SHOOT_LAYUP_T2]: 0, [SHOOT_LAYUP_T3]: 8, [SHOOT_LAYUP_T4]: 15},
  ...
  rightHipX: {[SHOOT_LAYUP_T0]: 20, [SHOOT_LAYUP_T1]: -20, [SHOOT_LAYUP_T2]: -50, [SHOOT_LAYUP_T3]: -25, [SHOOT_LAYUP_T4]: 20},
  ...
  leftKneeX: {[SHOOT_LAYUP_T0]: -15, [SHOOT_LAYUP_T1]: -20, [SHOOT_LAYUP_T2]: 0, [SHOOT_LAYUP_T3]: -8, [SHOOT_LAYUP_T4]: -15},
  ...
  // 右膝：高く上げる（ニードライブ）
  rightKneeX: {[SHOOT_LAYUP_T0]: -20, [SHOOT_LAYUP_T1]: -40, [SHOOT_LAYUP_T2]: -60, [SHOOT_LAYUP_T3]: -30, [SHOOT_LAYUP_T4]: -20},
...
const SHOOT_DUNK_JOINT_ANIMATIONS: Record<string, Record<number, number>> = {
  ...
  // 右腕：振り上げ→頂点→叩きつけ（Z=上げる高さ、Y=前方リーチ）
  rightShoulderX: {[SHOOT_DUNK_T0]: 30, [SHOOT_DUNK_T1]: 30, [SHOOT_DUNK_T2]: 30, [SHOOT_DUNK_T3]: 30, [SHOOT_DUNK_T4]: 30, [SHOOT_DUNK_T5]: 30},
  rightShoulderY: {[SHOOT_DUNK_T0]: 30, [SHOOT_DUNK_T1]: 40, [SHOOT_DUNK_T2]: 70, [SHOOT_DUNK_T3]: 30, [SHOOT_DUNK_T4]: 30, [SHOOT_DUNK_T5]: 30},
  rightShoulderZ: {[SHOOT_DUNK_T0]: 96, [SHOOT_DUNK_T1]: 110, [SHOOT_DUNK_T2]: 150, [SHOOT_DUNK_T3]: 60, [SHOOT_DUNK_T4]: 80, [SHOOT_DUNK_T5]: 96},

  rightElbowX: {[SHOOT_DUNK_T0]: -30, [SHOOT_DUNK_T1]: -60, [SHOOT_DUNK_T2]: -15, [SHOOT_DUNK_T3]: -40, [SHOOT_DUNK_T4]: -35, [SHOOT_DUNK_T5]: -30},
  ...
  // 左腕：補助→頂点で上げ→叩きつけ後は下ろす
  leftShoulderX: {[SHOOT_DUNK_T0]: 30, [SHOOT_DUNK_T1]: 30, [SHOOT_DUNK_T2]: 30, [SHOOT_DUNK_T3]: 30, [SHOOT_DUNK_T4]: 30, [SHOOT_DUNK_T5]: 30},
  leftShoulderY: {[SHOOT_DUNK_T0]: 25, [SHOOT_DUNK_T1]: 35, [SHOOT_DUNK_T2]: 65, [SHOOT_DUNK_T3]: 25, [SHOOT_DUNK_T4]: 25, [SHOOT_DUNK_T5]: 25},
  leftShoulderZ: {[SHOOT_DUNK_T0]: 90, [SHOOT_DUNK_T1]: 105, [SHOOT_DUNK_T2]: 145, [SHOOT_DUNK_T3]: 55, [SHOOT_DUNK_T4]: 75, [SHOOT_DUNK_T5]: 90},

  leftElbowX: {[SHOOT_DUNK_T0]: -30, [SHOOT_DUNK_T1]: -55, [SHOOT_DUNK_T2]: -20, [SHOOT_DUNK_T3]: -35, [SHOOT_DUNK_T4]: -35, [SHOOT_DUNK_T5]: -30},
  ...
  // 脚：力強いジャンプ→空中で膝を上げる
  leftHipX: {[SHOOT_DUNK_T0]: 15, [SHOOT_DUNK_T1]: 5, [SHOOT_DUNK_T2]: 0, [SHOOT_DUNK_T3]: 10, [SHOOT_DUNK_T4]: 5, [SHOOT_DUNK_T5]: 15},
  ...
  // 右脚：膝を高く上げる
  rightHipX: {[SHOOT_DUNK_T0]: 20, [SHOOT_DUNK_T1]: 10, [SHOOT_DUNK_T2]: -40, [SHOOT_DUNK_T3]: -20, [SHOOT_DUNK_T4]: 5, [SHOOT_DUNK_T5]: 20},
  ...
  leftKneeX: {[SHOOT_DUNK_T0]: -20, [SHOOT_DUNK_T1]: -25, [SHOOT_DUNK_T2]: 0, [SHOOT_DUNK_T3]: -5, [SHOOT_DUNK_T4]: -10, [SHOOT_DUNK_T5]: -20},
  ...
  // 右膝：空中で高く曲げる
  rightKneeX: {[SHOOT_DUNK_T0]: -20, [SHOOT_DUNK_T1]: -15, [SHOOT_DUNK_T2]: -50, [SHOOT_DUNK_T3]: -35, [SHOOT_DUNK_T4]: -20, [SHOOT_DUNK_T5]: -20},
...
const SHOOT_FEINT_JOINT_ANIMATIONS: Record<string, Record<number, number>> = {
  ...
  // 右腕（シュートハンド）：持ち上げかけて止める（Z=腕上げ、Y=前方）
  rightShoulderX: {[SHOOT_FEINT_T0]: 30, [SHOOT_FEINT_T1]: 30, [SHOOT_FEINT_T2]: 30, [SHOOT_FEINT_T3]: 30},
  rightShoulderY: {[SHOOT_FEINT_T0]: 30, [SHOOT_FEINT_T1]: 36, [SHOOT_FEINT_T2]: 33, [SHOOT_FEINT_T3]: 30},
  rightShoulderZ: {[SHOOT_FEINT_T0]: 96, [SHOOT_FEINT_T1]: 96, [SHOOT_FEINT_T2]: 96, [SHOOT_FEINT_T3]: 96},

  rightElbowX: {[SHOOT_FEINT_T0]: -30, [SHOOT_FEINT_T1]: -70, [SHOOT_FEINT_T2]: -50, [SHOOT_FEINT_T3]: -30},
  ...
  // 左腕（ガイドハンド）：補助
  leftShoulderX: {[SHOOT_FEINT_T0]: 30, [SHOOT_FEINT_T1]: 30, [SHOOT_FEINT_T2]: 30, [SHOOT_FEINT_T3]: 30},
  leftShoulderY: {[SHOOT_FEINT_T0]: 25, [SHOOT_FEINT_T1]: 33, [SHOOT_FEINT_T2]: 29, [SHOOT_FEINT_T3]: 25},
  leftShoulderZ: {[SHOOT_FEINT_T0]: 90, [SHOOT_FEINT_T1]: 90, [SHOOT_FEINT_T2]: 90, [SHOOT_FEINT_T3]: 90},

  leftElbowX: {[SHOOT_FEINT_T0]: -30, [SHOOT_FEINT_T1]: -50, [SHOOT_FEINT_T2]: -38, [SHOOT_FEINT_T3]: -30},
  ...
  leftHipX: {[SHOOT_FEINT_T0]: 20, [SHOOT_FEINT_T1]: 30, [SHOOT_FEINT_T2]: 25, [SHOOT_FEINT_T3]: 20},
  ...
  rightHipX: {[SHOOT_FEINT_T0]: 25, [SHOOT_FEINT_T1]: 35, [SHOOT_FEINT_T2]: 30, [SHOOT_FEINT_T3]: 25},
  ...
  leftKneeX: {[SHOOT_FEINT_T0]: -25, [SHOOT_FEINT_T1]: -40, [SHOOT_FEINT_T2]: -30, [SHOOT_FEINT_T3]: -25},
  ...
  rightKneeX: {[SHOOT_FEINT_T0]: -30, [SHOOT_FEINT_T1]: -40, [SHOOT_FEINT_T2]: -35, [SHOOT_FEINT_T3]: -30},
