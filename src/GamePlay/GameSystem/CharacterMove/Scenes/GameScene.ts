...
import { CharacterAI } from "@/GamePlay/GameSystem/CharacterMove/AI/CharacterAI";
...
import { PlayerStateManager, DefenseScheme, VisualSettingsManager } from "@/GamePlay/GameSystem/CharacterMove/State";
import { LooseBallDecisionSystem } from "@/GamePlay/GameSystem/CharacterMove/Systems/LooseBallDecisionSystem";
import { RiskAssessmentSystem } from "@/GamePlay/GameSystem/CharacterMove/Systems/RiskAssessmentSystem";
...
// import { ModelLoader } from "@/GamePlay/GameSystem/CharacterMove/Loaders/ModelLoader"; // 一旦無効化
import {
  LIGHT_CONFIG,
  // MODEL_CONFIG, // 一旦無効化
...
import { PassCheckController, DefenderPlacement } from "@/GamePlay/GameSystem/CharacterMove/Controllers/Check/PassCheckController";
import {
  JumpBallInfo,
...
} from "@/GamePlay/GameSystem/CharacterMove/Scenes/Game";
import type { GameMode } from "@/GamePlay/GameSystem/CharacterMove/Scenes/Game";

// GameModeを再エクスポート（後方互換性のため）
export type { GameMode } from "@/GamePlay/GameSystem/CharacterMove/Scenes/Game";
