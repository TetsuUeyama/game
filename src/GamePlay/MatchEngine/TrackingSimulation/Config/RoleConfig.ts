...
export type SimOffenseRole = 'MAIN_HANDLER' | 'SECOND_HANDLER' | 'SPACER' | 'SCREENER' | 'DUNKER' | 'SLASHER';
...
export const ZONE_SG_CORNER: SimZone  = { xMin: 3.5,  xMax: 5.5,  zMin: 2.5,  zMax: 4.0 };
...
export const ROLE_ASSIGNMENTS: {
  ...
  targets: [
    ...
    { position: 'SG', role: 'SPACER', zone: ZONE_SG_CORNER, homeX: 4.5, homeZ: 3.25, speedMult: 0.9, reevalInterval: 2.5 },
  ],
};
...
export const SPACER_SPREAD_MIN = 2.0;
